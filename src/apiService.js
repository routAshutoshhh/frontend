...
export const addServiceProvider = (serviceProvider) =>
  api.post("/service-providers", serviceProvider);
...
export const updateServiceProvider = (id, serviceProvider) =>
  api.put(`/service-providers/${id}`, serviceProvider);
...
export const fetchStationaryShopById = (id) =>
  api.get(`/stationary-shops/${id}`);
export const updateStationaryShop = (id, shop) =>
  api.put(`/stationary-shops/${id}`, shop);
export const deleteStationaryShop = (id) =>
  api.delete(`/stationary-shops/${id}`);
...
export const updateItem = (id, item) =>
  api.put(`/stationary-items/${id}`, item);
export const deleteItem = (id) => api.delete(`/stationary-items/${id}`);

export const fetchStatCartItems = () => api.get("/stat-cart-items");
export const addStatCartItem = (cartItem) =>
  api.post("/stat-cart-items", cartItem);
export const fetchStatCartItemById = (id) => api.get(`/stat-cart-items/${id}`);
export const updateStatCartItem = (id, cartItem) =>
  api.put(`/stat-cart-items/${id}`, cartItem);
export const deleteStatCartItem = (id) => api.delete(`/stat-cart-items/${id}`);
...
export const addOrderTracking = (tracking) =>
  api.post("/order-tracking", tracking);
export const fetchOrderTrackingById = (id) => api.get(`/order-tracking/${id}`);
export const updateOrderTracking = (id, tracking) =>
  api.put(`/order-tracking/${id}`, tracking);
